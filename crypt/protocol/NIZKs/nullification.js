 ...
 * @param {Point} m 
 */
function nullificationCommitment(c, I, B, A, c_d, Ds, m) {
    this.c = c;
    this.I = I;
    this.B = B;
    this.A = A;
 ...
 * @returns 
 */
nullificationCommitment.prototype.toBytes = function (ec) {
    return [
 ...
 * @param {*} bytes 
 * @param {EC} ec 
 * @returns {nullificationCommitment}
 */
nullificationCommitment.fromBytes = function (bytes, ec) {
    ...
    return new nullificationCommitment(c, I, B, A, c_d, Ds, m);
};
 ...
 * @param {nullificationCommitment} comm 
 * @param {BN} y 
 */
...
/**
 * 
 * @param {nullificationCommitment} Commitment 
...
NullificationNIZK.prototype.simulate = function (ch) {
    ...
    proof.commitment = new nullificationCommitment();
