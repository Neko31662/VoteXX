...
ElgamalEnc.decrypt = function (privKey, ciphertext, curve) {
    let c1_privKey = ciphertext.c1.mul(privKey);
...
LiftedElgamalEnc.decrypt = function (privKey, ciphertext, curve) {
    let g_msg = ElgamalEnc.decrypt(privKey, ciphertext);
...
class KeyPair {
    ...
    constructor(group) {
        ...
        this.pk = new ElgamalPublicKey(this.group, this.group.g.mul(this.sk));
    }
}
